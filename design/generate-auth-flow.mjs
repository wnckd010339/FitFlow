...
const brand = () => `${circle(64,52,22,C.lime)}${text(64,59,"F",17,C.dark,900,"middle")}${text(98,60,"FitFlow",24,C.dark,900)}`;
...
${rect(0,0,650,1024,C.dark,0)}${circle(72,68,25,C.lime)}${text(72,76,"F",20,C.dark,900,"middle")}${text(112,77,"FitFlow",29,C.white,900)}
...
${rect(650,0,790,1024,C.bg,0)}${text(824,178,"FitFlow 시작하기",32,C.ink,900)}${text(824,214,"가입한 방식으로 로그인해 주세요.",14,C.muted,500)}
...
${text(482,402,"아이디와 비밀번호로 가입",17,C.ink,900)}${text(482,430,"FitFlow 전용 로그인 정보를 새로 만들어요.",12,C.muted,500)}${text(1014,424,"›",26,C.green,800,"end")}
...
${rect(250,176,940,788,C.white,28,C.line)}${text(294,226,"일반 회원가입",26,C.ink,900)}${text(294,256,"FitFlow 전용 계정과 센터 이용 정보를 입력해 주세요.",13,C.muted,500)}
...
${text(720,872,"Google 비밀번호는 FitFlow에 저장되지 않습니다.",11,C.muted,500,"middle")}
